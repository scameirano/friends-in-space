...
OnlineMap = {
    ...
    init: function (container) {
        ...
        self._dom.singleMarkerPopup = $('<div class="single-marker-popup"><div class="image"></div><div class="user"><span class="user-name"></span> &#8213; <span class="user-location"></span></div><div class="statistics"><span class="sam-orbits"><span class="sam-orbits-number"></span> ORBITS WITH SAM</span> / <span class="connected-people"><span class="connected-people-number"></span> FRIENDS IN SPACE</span></div><div class="not-logged-in-notice">log in for more features</div><div class="actions"><span class="popup-action"><a class="interactions user-interactions"><span>See Activity</span></a></span><span class="chat-interactions"><span class="popup-action"><a class="interactions chat" onclick="">Chat</a></span></span><span class="twitter-interactions"><span class="popup-action"><a class="interactions tweet" href="" onclick="window.open(this.href, \'mywin\',\'left=20,top=20,width=500,height=500,toolbar=1,resizable=0\'); return false;">Tweet</a></span><span class="popup-action"><a class="interactions twitter-account" href="" target="_blank">Twitter profile</a></span></span><span class="google-plus-interactions"><span class="popup-action"><a class="interactions google-plus-account" href="" target="_blank">Google+ profile</a></span></span><span class="facebook-interactions"><span class="popup-action"><a class="interactions facebook-account" href="" target="_blank">Facebook profile</a></span></span></div></div>')
